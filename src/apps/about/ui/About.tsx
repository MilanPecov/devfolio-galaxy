...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Technical Consulting & Mentoring Section - Redesigned for better visual appeal */}
      <section className="py-20 bg-indigo-50/50">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {/* Service Card 1 - Redesigned for better visual appeal */}
            ...
            {/* Service Card 2 - Redesigned for better visual appeal */}
            <Card className="bg-white border-indigo-100 overflow-visible group hover:shadow-md transition-all hover:-translate-y-1">
              <CardContent className="p-0">
                <div className="relative">
                  {/* Icon positioned for better alignment with title */}
            ...
            {/* Service Card 3 - Redesigned for better visual appeal */}
            <Card className="bg-white border-indigo-100 overflow-visible group hover:shadow-md transition-all hover:-translate-y-1">
              <CardContent className="p-0">
                <div className="relative">
                  {/* Icon positioned for better alignment with title */}
